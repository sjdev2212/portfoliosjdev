...
const Scraper = ({ activeScraper, setActiveScraper }) => {
    ...
    <>
      <div className="task-content">
        <div className="task-content-upper">
          <h2>Web Scraper</h2>
          <p>
            This full-stack web application, built with Ruby on Rails, allows
            users to log in securely using the Devise gem. Once logged in, users
            can upload a CSV file containing a list of words. The app performs a
            Google search for each word, retrieving the number of search
            results, AdWords count, the number of links, and the HTML code of
            the page or cache. It then presents this data in an organized and
            user-friendly interface, making it easy for users to analyze search
            engine data directly from the app
          </p>
        ...
        <div className="task-content-downer">
          ...
          <div className="task-btns">
            ...
            <div onClick={handleActiveScraper} className="btn">
              <RiArrowGoBackFill
                style={{
                  marginBottom: "2vw",
                  fontSize: "2vw",
